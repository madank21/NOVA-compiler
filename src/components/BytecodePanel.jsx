        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-[#252526] text-gray-400 border-b border-[#333333]">
              <th className="p-2.5 border-r border-[#333333]">PC (Offset)</th>
              <th className="p-2.5 border-r border-[#333333]">Opcode</th>
              <th className="p-2.5 border-r border-[#333333]">Symbol / Target</th>
              <th className="p-2.5 border-r border-[#333333]">Raw Operand</th>
              <th className="p-2.5">C Source Line</th>
            </tr>
          </thead>
          <tbody>
            {bytecode.map((instr, idx) => (
              <tr key={idx} className="border-b border-[#2a2a2a] hover:bg-[#252526] transition">
                ...
                <td className="p-2.5 text-gray-400">Line {instr.line}</td>
              </tr>
            ))}
          </tbody>
        </table>
